        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list" style="overflow: hidden; width: auto; height: calc(-184px + 100vh);">
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-account-add"></i><span>Vets</span> </a>
                        <ul class="ml-menu">
                            <li><a href="vet.php">Add Vet</a>
                            </li>
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-account-o"></i><span>Farmer</span> </a>
                        <ul class="ml-menu">
                    ...
                    <li> <a href="javascript:void(0);" class="menu-toggle toggled waves-effect waves-block"><i
                        ...
                        <ul class="ml-menu" style="display: block;">
                            <li><a href="department.php" class=" waves-effect waves-block">Add Bull Catalog</a></li>
                            <li><a href="viewdepartment.php" class=" waves-effect waves-block">View Bull Catalog</a></li>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-account-o"></i><span>Farmer</span> </a>
                        <ul class="ml-menu">
                            <li><a href="viewfarmer.php">View Farmer</a>
                            </li>
                        </ul>
                    </li>
