...
if(isset($_POST[submit]))
{
	if(isset($_GET[editid]))
	{
		...
		{
			echo "<script>alert('Vet Timings record updated successfully...');</script>";
		}
		else
		{
	...
	if($qsql = mysqli_query($con,$sql))
	{
		echo "<script>alert('Vet Timings record inserted successfully...');</script>";
	}
	else
	{
		echo mysqli_error($con);
...
<div class="container-fluid">
	<div class="block-header">
            <h2 class="text-center">Add New Vet Timings</h2>
