...
<li><a href=" ######### ">Farmer</a>
    <ul>
   <li><a href="farmer.php">Add Farmer</a></li>
        <li><a href="viewfarmer.php">View Farmer Records</a></li>
    </ul>
</li>
<li>
...
<a href=" ######### ">Vet</a>
    <ul>
    <li><a href="vet.php">Add Vet</a></li>
    <li><a href="Viewdoctor.php">View Vet</a></li>
     <li><a href="doctortimings.php">Add Vet Timings</a></li>
    <li><a href="viewdoctortimings.php">View Vet Timings</a></li>
 </ul>
</li>
...
<a href=" ######### ">Settings</a>
    <ul>
       	...
       	<li><a href="department.php" style="width:150px;">Add Bull Catalog</a></li>
    	<li><a href="Viewdepartment.php" style="width:150px;">View Bull Catalog</a></li>
...
<div id="mmenu">
    ...
    <li><a href=" ######### ">Farmer</a>
        <ul>
       <li><a href="viewfarmer.php">View Farmer</a></li>
        </ul>
    </li>
       <li><a href=" ######### ">Vet Timings</a>
        <ul>
...
?>
<div id="mmenu">
<li><a href="farmeraccount.php">Account</a></li>
<li>
<a href=" ######### ">Appointment</a>
    <ul>
    <li><a href="farmerappointment.php" style="width:200px;">Add Appointment</a></li>
