		...
		<table class="table table-bordered table-striped table-hover js-basic-example dataTable">
			...
			<tbody>
				...
				while($rs = mysqli_fetch_array($qsql))
				{
					...
					<td>$rs[status]</td>
					<td>&nbsp;
					<a href='doc.php?editid=$rs[doctorid]' class='btn btn-sm btn-raised g-bg-cyan'>Edit</a> <a href='viewdoc.php?delid=$rs[doctorid]' class='btn btn-sm btn-raised g-bg-blush2'>Delete</a> </td>
					</tr>";
				}
				?>      </tbody>
			</table>
