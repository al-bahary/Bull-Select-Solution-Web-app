...
if(isset($_POST[submitpat]))
{
	...
	{
		echo "<script>alert('farmers record inserted successfully...');</script>";
	}
	else
	{
...
<form method="post" action="" name="frmpatdet" onSubmit="return validateform()">
      ...
      <tbody>
     <tr>
                <td width="17%"><strong>Farmer Name </strong></td>
                <td width="41%"><input type="text" name="patientname" id="patientname"/></td>
                <td width="16%"><strong>Farmer ID</strong></td>
...
?>
    ...
    <table class="table table-bordered table-striped">
      <tbody>
        <tr>
          <td width="16%"><strong>Farmer Name </strong></td>
...
function validateform()
{
	...
	{
		alert("farmer ID should not be empty..");
