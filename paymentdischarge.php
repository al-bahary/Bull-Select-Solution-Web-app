...
if(isset($_POST["submitfullamount"]))
{
 ...
 echo "<script>window.location='farmerreport.php?patientid=$_GET[patientid]&appointmentid=$_GET[appointmentid]'</script>";
}
...
<div class="container-fluid">
  ...
  <div class="card" style="padding: 10px">
      ...
      <table width="342" border="3">
        <thead>
          <tr>
            <td colspan="2" align="center"><a href='farmerreport.php?patientid=<?php echo $_GET[patientid]; ?>&appointmentid=<?php echo $_GET[appointmentid]; ?>'><strong>View Patient Report>></strong></a></td>
          </tr>
        </thead>
      </table>   
</section>   
