        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-account-add"></i><span>Vet</span> </a>
                        <ul class="ml-menu">
                            <li><a href="doctor.php">Add Vet</a>
                            </li>
                    ...
                    <li> <a href="javascript:void(0);" class="menu-toggle"><i
                        ...
                        <ul class="ml-menu">
                            <li><a href="department.php">Add Bull Catalog</a></li>
                            <li><a href="viewdepartment.php">View Bull Catalog</a></li>
