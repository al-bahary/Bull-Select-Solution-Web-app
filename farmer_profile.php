...
<body>
	...
	<aside class="sidebar-left" style="width: 200px;">
		...
		<div class="sidebar-links">
			...
			<a class="link-yellow selected" href="farmer_profile.php"><i class="fa fa-keyboard-o"></i>View Profile</a>
	...
	<div class="main-content">
		...
		<div class="container" style="width: 918px; margin-top: -121px;">
			...
			<div class="heading">
				<h2>Please Enter Farmers Details</h2>
...
<div class="copyright">
	...
	function patient_pg(page,id){
		if(page==1)
		{
				$('#show_login').load('addfarmer.php?id='+id);}
				if(page==2)
				{
					...
					if(page==3)
				{
					$('#show_login').load('viewfarmer.php');
				}
