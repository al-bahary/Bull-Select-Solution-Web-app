...
?>			
          ...
          <select name="select4" id="select4" class="form-control show-tick">
           <option value="">Select</option>
			...
			while($rstreatment=mysqli_fetch_array($qsqltreatment))
			{
				...
				{
				echo "<option value='$rstreatment[treatmentid]' selected>$rstreatment[treatmenttype]  - (Ksh. $rstreatment[treatment_cost])</option>";
				}
				else
				{
					echo "<option value='$rstreatment[treatmentid]'>$rstreatment[treatmenttype]  - (Ksh. $rstreatment[treatment_cost])</option>";
				}
        ...
        <tr>
          <td colspan="2" align="center"><input class="form-control" type="submit" name="submit" id="submit" value="Submit" /> | <a href='farmerreport.php?patientid=<?php echo $_GET[patientid]; ?>&appointmentid=<?php echo $_GET[appid]; ?>'><strong>View Farmer Report>></strong></a></td>
        </tr>
      </tbody>
    </table>
    </form>
