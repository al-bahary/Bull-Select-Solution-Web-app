    ...
    <table class="table table-bordered table-striped table-hover js-exportable dataTable" >
      ...
      <tbody>
        ...
        echo "<tr>
          ...
          <td>&nbsp;$rs[status]</td>
          <td width='250'>&nbsp;<a href='doctimings.php?editid=$rs[doctor_timings_id]' class='btn btn-raised btn-sm g-bg-cyan'>Edit</a>  <a href='viewdoctimings.php?delid=$rs[doctor_timings_id]' class='btn btn-raised btn-sm g-bg-blush2'>Delete</a> </td>
        </tr>";
		}
		?>
