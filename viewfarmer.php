...
<div class="container-fluid">
  <div class="block-header">
    <h2 class="text-center">View Farmer Records</h2>
    ...
    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
      ...
      <tbody>
       ...
       while($rs = mysqli_fetch_array($qsql))
       {
        ...
        {
          echo "<a href='farmer.php?editid=$rs[patientid]' class='btn btn-sm btn-raised bg-green'>Edit</a><a href='viewpatient.php?delid=$rs[patientid]' class='btn btn-sm btn-raised bg-blush'>Delete</a> <hr>
          <a href='farmerreport.php?patientid=$rs[patientid]' class='btn btn-sm btn-raised bg-cyan'>View Report</a>";
        }
        echo "</td></tr>";
      }
      ?>
